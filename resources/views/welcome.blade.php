    ...
    <body id="page-top mb-5">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top " id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" style="width:300px;height:300px;" src="assets/img/profile.jpg" alt="..." /></span>
            </a>
                ...
                <div class="resume-section-content">
                    ...
                    <ul class="fa-ul mb-0">
                        <li>
                            ...
                            Android App Components-Coursera
                        </li>
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
